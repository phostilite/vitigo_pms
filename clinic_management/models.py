...
class PaymentTerminal(models.Model):
    """Payment terminal/device configuration"""
    name = models.CharField(max_length=100)
...
class VisitPaymentTransaction(models.Model):
    """Track payment transactions for clinic visits"""
    visit = models.ForeignKey(ClinicVisit, on_delete=models.CASCADE, related_name='payment_transactions')
    ...
    def __str__(self):
        return f"Payment of {self.amount} for {self.visit}"
