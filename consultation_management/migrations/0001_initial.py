    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient_instructions', models.TextField(blank=True, help_text='Instructions for the patient to follow')),
                ('lifestyle_instructions', models.TextField(blank=True, help_text='Lifestyle and dietary instructions for the patient')),
                ('care_instructions', models.TextField(blank=True, help_text='Care and precaution instructions')),
