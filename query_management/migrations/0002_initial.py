...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='report',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='query_management.reportcategory'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='reportexport',
            name='report',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exports', to='query_management.report'),
        ),
    ]
